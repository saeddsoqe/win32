...
/*osEE_hal_get_msb this function returns the index of the most significant bit of the mask parameter.
   Example: if the mask value is 0x0100, the function returns 9 */
/*go to ee_std_change_context.h to line 185 note this file is very related to ee_compiler.h */
