...
#.........................................................................#
##Used to test EEOPTs defined in the OIL file or generated by RT-Druid. 
...
#endif
#this section for make files 
OS_EE_PULL_MK_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_arch_rules.mk
#to be modifided to win32 directory 
#OS_EE_PULL_MK_FILES += $(ERIKA_FILES)/pkg/arch/x86-64/$(OSEE_PLATFORM)/ee_arch_cfg.mk
OS_EE_PULL_MK_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_arch_cfg.mk
#OS_EE_PULL_MK_FILES += $(ERIKA_FILES)/pkg/arch/x86-64/$(OSEE_PLATFORM)/ee_arch_compiler_gcc.mk
OS_EE_PULL_MK_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_arch_compiler_gcc.mk
#i think in this section we need to modify thr directory to point to 
#files in win32 
#this to includes .h and .c
#i already replaced the x86-64 directory by win32
OS_EE_PULL_INC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee.h #with us
OS_EE_PULL_INC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_conf.h#with us
OS_EE_PULL_INC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_arch_override.h #with us
OS_EE_PULL_INC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_arch_compiler_gcc.h #with us
OS_EE_PULL_INC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_platform_types.h  #with us
OS_EE_PULL_INC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_get_kernel_and_core.h #with us
OS_EE_PULL_INC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_hal.h #with us
OS_EE_PULL_INC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_hal_internal_types.h #with us

OS_EE_PULL_SRC_FILES += $(ERIKA_FILES)/pkg/std/arch/ee_std_hal_init.c
#modified and replaced  
#ee_x86_64_int.c => ee_Win32_int.c
#ee_x86_64_ctx.S => ee_Win32_ctx.S 
# ee_x86_64_system_timer.c => ee_Win32_system_timer.c
#OS_EE_PULL_SRC_FILES += $(ERIKA_FILES)/pkg/arch/x86-64/ee_x86_64_int.c
OS_EE_PULL_SRC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_Win32_int.c
#OS_EE_PULL_SRC_FILES += $(ERIKA_FILES)/pkg/arch/x86-64/ee_x86_64_ctx.S
OS_EE_PULL_SRC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_Win32_ctx.S

OS_EE_PULL_SRC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_hal_internal.h  #with us

OS_EE_PULL_SRC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_internal.h #with us 

OS_EE_PULL_SRC_FILES += $(ERIKA_FILES)/pkg/arch/win32/ee_Win32_system_timer.c
#needed 
#system timer.c
#ee_x86_64_int.c
# ee_x86_64_system_timer.c => ee_Win32_system_timer.c
...
#this point to the file contain system timer so 
#we need to make it points to our file that contains our software timer implementaion 
#ifeq  ($(call iseeopt, OSEE_HAS_SYSTEM_TIMER), yes)
#ee_x86_64_system_timer.c
#OS_EE_PULL_SRC_FILES += $(ERIKA_FILES)/pkg/arch/x86-64/ee_x86_64_system_timer.c
#endif # OSEE_HAS_SYSTEM_TIMER

#we will discuss 
#we will remove this file because we will our interrupt handling
